...
COPY --from=build /home/gradle/src/build/libs/*.jar app-bravo.jar

EXPOSE 8080
EXPOSE 8081
USER klovercloud

ENTRYPOINT ["java", "-XX:+UnlockExperimentalVMOptions", "-XX:+UseContainerSupport", "-Djava.security.egd=file:/dev/./urandom","-jar","/home/klovercloud/app-bravo.jar"]
